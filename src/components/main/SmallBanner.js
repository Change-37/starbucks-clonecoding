        ...
        <div className="s-main-banner">
          <div className="s-main-inner">
            <div className="s-slogan">
              ...
              <button className="s-btn-slogan">자세히 보기</button>
            </div>
            <div className="new">
              <img
                className="s-new-one"
            ...
            <div className="s-rewards-content">
              <div className="s-rewards-join">
                ...
                >
                  ...
                  <div className="s-rewards-button">
                    <button className="s-rewards-join-btn">회원가입</button>
                    <button className="s-rewards-login-btn">로그인</button>
                  </div>
                </div>
              </div>
              <div className="s-rewards-giftcard">
                <div className="s-rewards-giftcard-text">
                  ...
                  <b>"나에게 선물하기"로 구매하시고, 편리하게 등록하세요!</b>
                  <br />
                  카드를 등록하여 스타벅스 리워드 회원이 되신 후, <br /> 첫
