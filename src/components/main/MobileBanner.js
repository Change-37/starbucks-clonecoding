      ...
      <main role="main" className="m-main">
        <div className="m-main-banner">
          <div className="m-main-inner">
            ...
            <div>
              <button className="m-btn-slogan">자세히 보기</button>
            </div>
          </div>
        </div>
              ...
              <div className="m-rewards-join">
                ...
                <div>
                  ...
                  <div className="m-rewards-button">
                    <button className="m-rewards-join-btn">회원가입</button>
                    <button className="m-rewards-login-btn">로그인</button>
                  </div>
                </div>
              </div>
